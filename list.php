...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($_FILES['image']['name'])) {
        ...
        if ($err_msg == '') {
            $sql = 'INSERT INTO images(image_name, image_type, image_content, image_size, userName, created_at)
                    VALUES (:image_name, :image_type, :image_content, :image_size, :userName, now())';
            $stmt = $pdo->prepare($sql);
...
<header><li><a href="logout.php" class="btn btn-danger ml-3">サインアウト</a></li>
<br>
